...
import ru.verso.picturesnap.databinding.FragmentPhotographerServicesBottomSheetBinding;
...
public class PhotographerServicesBottomSheet extends Fragment {

    private FragmentPhotographerServicesBottomSheetBinding binding;

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {

        binding = FragmentPhotographerServicesBottomSheetBinding.inflate(inflater, container, false);
    ...
    private void createServicesList(ServicesViewModel viewModel) {
        ...
        viewModel.getPhotographerServices().observe(getViewLifecycleOwner(), adapter::submitList);
    }
