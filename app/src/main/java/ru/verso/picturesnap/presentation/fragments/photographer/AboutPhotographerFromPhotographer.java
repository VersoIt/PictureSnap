...
import ru.verso.picturesnap.databinding.FragmentAboutPhotographerFromPhotographerBinding;
import ru.verso.picturesnap.presentation.viewmodel.unregistered.AboutPhotographerFromClientViewModel;

public class AboutPhotographerFromPhotographer extends Fragment {

    private FragmentAboutPhotographerFromPhotographerBinding binding;

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = FragmentAboutPhotographerFromPhotographerBinding.inflate(inflater, container, false);
