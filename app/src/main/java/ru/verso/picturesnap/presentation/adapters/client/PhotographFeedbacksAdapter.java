...
public class PhotographFeedbacksAdapter extends ListAdapter<Feedback, FeedbackViewHolder> {

    public PhotographFeedbacksAdapter(@NonNull DiffUtil.ItemCallback<Feedback> diffCallback) {
        super(diffCallback);
    }
